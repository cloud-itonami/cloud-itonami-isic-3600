# Operator Quickstart — Community Water Safety Operations

Shortest path from clone to a verified local dry-run for **ISIC 3600** (`cloud-itonami-isic-3600`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-3600.git
cd cloud-itonami-isic-3600
```
...
- Blueprint governor key: `water-safety-governor`
- Likely source path: `water.governor.cljc`
